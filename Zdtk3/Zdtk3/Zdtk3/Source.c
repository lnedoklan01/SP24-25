...
//funckija findPrevious pronalazi prethodnika u vezanoj listi
...
//fukcija insertAfterPerson kreira novu osobu na mjesto u listi koje mi odredimo 
int insertAfterPerson(Position person);

//funckija swapItems mijenja mjesto osobi u listi
int swapItems(Position first, Position second);

//funckija bubbleSort sortira listu
...
int menu(Position head) {
	...
	while (1) {
		...
		printf("6. Insert after specified item\n");
		printf("7. Insert before specified item\n");
